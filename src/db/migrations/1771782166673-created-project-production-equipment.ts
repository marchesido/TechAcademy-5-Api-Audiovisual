...
export class CreatedProjectProductionEquipment1771782166673 implements MigrationInterface {
    name = 'CreatedProjectProductionEquipment1771782166673'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_7d12d8b9d541c63f0c3e83669c" ON "equipments" ("serialNumber") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_7d12d8b9d541c63f0c3e83669c"`);
