...
export class CreateProductionEquipmentDto {
  @ApiProperty({ 
    description: 'ID da Produção que receberá o equipamento', 
    example: 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11' 
  })
  @IsUUID('4', { message: 'O ID da produção deve ser um UUID válido' })
  @IsNotEmpty({ message: 'O vínculo com uma produção é obrigatório' })
  productionId: string;
